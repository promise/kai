...
module.exports.execute = (interaction = new CommandInteraction, { group, id, quickresponse, training_data = null, percentage = undefined }) => TrainingModel.findOne({ name: group }, (_, model) => {
