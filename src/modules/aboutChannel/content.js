const
  { emojis } = require("../../database"),
  gh = emojis.get("github"),
  tw = emojis.get("twitter"),
  pt = emojis.get("patreon"),
  kf = emojis.get("kofi"),
  iv = emojis.get("invite"),
  ws = "🌐",
  dc = "📋",
  sp = "💫",
  zwsp = require("../../constants/embeds").zero_width_space;

module.exports = [
  "promise_solutions.png",
  {
    embed: {
      description: [
  ...
  "frequently_asked_questions.png",
  {
    embed: {
      fields: [
        {
